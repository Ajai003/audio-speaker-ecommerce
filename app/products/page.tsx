            ...
            >
              ...
              >
                ...
                <div className="mt-4">
                  ...
                  <CreepyButton className="mt-4 w-full rounded-full bg-white px-4 py-2.5 text-sm font-semibold text-black transition-all duration-300 hover:shadow-[0_0_20px_rgba(255,255,255,0.1)] active:scale-95">
                    Add to Cart
                  </CreepyButton>
                </div>
              </motion.div>
